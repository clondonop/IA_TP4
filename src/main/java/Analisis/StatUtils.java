...
public final class StatUtils {
     ...
     */
    public static double kurtosis(ArrayList<Double> data) {
        double mean = mean(data);
        double numerator = 0, denominator = 0;

        for (int i = 0; i < data.size(); i++) {
            numerator += Math.pow(data.get(i) - mean, 4);
            denominator += Math.pow(data.get(i) - mean, 2);
        }

        numerator = 1.0 / data.size() * numerator;

        denominator = Math.pow(denominator * 1.0 / data.size(), 2);
     ...
     */
    public static double populationCovariance(ArrayList<Double> x, ArrayList<Double> y) {
        double xmean = mean(x);
        double ymean = mean(y);
     ...
     */
    public static double populationKurtosis(ArrayList<Double> data) {
        double mean = mean(data);
        ...
        for (int i = 0; i < data.size(); i++) {
            sum += Math.pow((data.get(i) - mean) / standardDeviation, 4);
        }
     ...
     */
    public static double populationSkewness(ArrayList<Double> data) {
        double mean = mean(data);
        double standardDeviation = standardDeviation(data);
        ...
        for (int i = 0; i < data.size(); i++) {
            sum += Math.pow((data.get(i) - mean) / standardDeviation, 3);
        }
     ...
     */
    public static double populationStandardDeviation(ArrayList<Double> data) {
     ...
     */
    public static double populationVariance(ArrayList<Double>data) {
        double mean = mean(data);
     ...
     */
    public static double skewness(ArrayList<Double> data) {
        double mean = mean(data);
        double numerator = 0, denominator = 0;

        for (int i = 0; i < data.size(); i++) {
            numerator += Math.pow(data.get(i) - mean, 3);
            denominator += Math.pow(data.get(i) - mean, 2);
        }

        numerator = 1.0 / data.size() * numerator;

        denominator = Math.pow(denominator * 1.0 / data.size(), 3.0 / 2.0);
